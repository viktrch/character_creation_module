...
class Warrior(Character):   
    ...
    SHORT_DESC = 'Воитель — отличный боец ближнего боя.'
...
class Mage(Character):
    ...
    SPECIAL_SKILL = 'Атака'
    SHORT_DESC = 'Маг — превосходный укротитель стихий.'
...
class Healer(Character):
    ...
    SHORT_DESC = 'Лекарь — чародей, способный исцелять раны.'
...
def start_training(character):
    ...
    print(f'{char_name}, ты {character.SHORT_DESC}')
